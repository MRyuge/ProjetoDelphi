...
function TDSServerModule1(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TDSServerModule1",connectionInfo);

  /*
   * @param JSON [in] - Type on server: string
   * @return result - Type on server: Boolean
   */
  this.updatePessoa = function(JSON) {
    var returnObject = this.executor.executeMethod('Pessoa', "POST", [JSON], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.updatePessoa_URL = function(JSON) {
    return this.executor.getMethodURL("Pessoa", "POST", [JSON], arguments[1])[0];
  };
   ...
   * @return result - Type on server: Boolean
   */
  this.acceptPessoa = function(JSON) {
    var returnObject = this.executor.executeMethod('Pessoa', "PUT", [JSON], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.acceptPessoa_URL = function(JSON) {
    return this.executor.getMethodURL("Pessoa", "PUT", [JSON], arguments[1])[0];
  };

  /*
   * @param IdPessoa [in] - Type on server: Int64
   * @return result - Type on server: Boolean
   */
  this.cancelPessoa = function(IdPessoa) {
    var returnObject = this.executor.executeMethod('Pessoa', "DELETE", [IdPessoa], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.IdPessoa = IdPessoa;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.cancelPessoa_URL = function(IdPessoa) {
    return this.executor.getMethodURL("Pessoa", "DELETE", [IdPessoa], arguments[1])[0];
  };

  /*
   * @return result - Type on server: string
   */
  this.ListarPessoas = function() {
    var returnObject = this.executor.executeMethod('ListarPessoas', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.ListarPessoas_URL = function() {
    return this.executor.getMethodURL("ListarPessoas", "GET", [], arguments[0])[0];
  };
   ...
   * @return result - Type on server: Boolean
   */
  this.updatePessoaEmLote = function(JSON) {
    var returnObject = this.executor.executeMethod('PessoaEmLote', "POST", [JSON], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.updatePessoaEmLote_URL = function(JSON) {
    return this.executor.getMethodURL("PessoaEmLote", "POST", [JSON], arguments[1])[0];
  };
   ...
   * @return result - Type on server: TJSONObject
   */
  this.BuscarPessoa = function(IdPessoa) {
    var returnObject = this.executor.executeMethod('BuscarPessoa', "GET", [IdPessoa], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.BuscarPessoa_URL = function(IdPessoa) {
    return this.executor.getMethodURL("BuscarPessoa", "GET", [IdPessoa], arguments[1])[0];
  };
   ...
   * @return result - Type on server: Boolean
   */
  this.updateEndereco = function(JSON) {
    var returnObject = this.executor.executeMethod('Endereco', "POST", [JSON], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.updateEndereco_URL = function(JSON) {
    return this.executor.getMethodURL("Endereco", "POST", [JSON], arguments[1])[0];
  };
   ...
   * @return result - Type on server: Boolean
   */
  this.acceptEndereco = function(JSON) {
    var returnObject = this.executor.executeMethod('Endereco', "PUT", [JSON], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.acceptEndereco_URL = function(JSON) {
    return this.executor.getMethodURL("Endereco", "PUT", [JSON], arguments[1])[0];
  };

  /*
   * @param IdEndereco [in] - Type on server: Int64
   * @return result - Type on server: Boolean
   */
  this.cancelEndereco = function(IdEndereco) {
    var returnObject = this.executor.executeMethod('Endereco', "DELETE", [IdEndereco], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.IdEndereco = IdEndereco;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.cancelEndereco_URL = function(IdEndereco) {
    return this.executor.getMethodURL("Endereco", "DELETE", [IdEndereco], arguments[1])[0];
  };

  /*
   * @return result - Type on server: string
   */
  this.ListarEnderecos = function() {
    var returnObject = this.executor.executeMethod('ListarEnderecos', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.ListarEnderecos_URL = function() {
    return this.executor.getMethodURL("ListarEnderecos", "GET", [], arguments[0])[0];
  };
   ...
   * @return result - Type on server: TJSONObject
   */
  this.BuscarEndereco = function(IdEndereco) {
    var returnObject = this.executor.executeMethod('BuscarEndereco', "GET", [IdEndereco], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.BuscarEndereco_URL = function(IdEndereco) {
    return this.executor.getMethodURL("BuscarEndereco", "GET", [IdEndereco], arguments[1])[0];
  };

  this.AtualizarIntegracaoViaCep = function() {
    this.executor.executeMethod('AtualizarIntegracaoViaCep', "GET", [], arguments[0], false, arguments[1], arguments[2]);
  };

  this.AtualizarIntegracaoViaCep_URL = function() {
    return this.executor.getMethodURL("AtualizarIntegracaoViaCep", "GET", [], arguments[0])[0];
  };
   ...
   * @return result - Type on server: TJSONObject
   */
  this.BuscarEnderecoIntegracao = function(IdEndereco) {
    var returnObject = this.executor.executeMethod('BuscarEnderecoIntegracao', "GET", [IdEndereco], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.BuscarEnderecoIntegracao_URL = function(IdEndereco) {
    return this.executor.getMethodURL("BuscarEnderecoIntegracao", "GET", [IdEndereco], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TDSServerModule1": ["updatePessoa","acceptPessoa","cancelPessoa","ListarPessoas","updatePessoaEmLote","BuscarPessoa","updateEndereco","acceptEndereco","cancelEndereco","ListarEnderecos","BuscarEndereco","AtualizarIntegracaoViaCep","BuscarEnderecoIntegracao"]
};
